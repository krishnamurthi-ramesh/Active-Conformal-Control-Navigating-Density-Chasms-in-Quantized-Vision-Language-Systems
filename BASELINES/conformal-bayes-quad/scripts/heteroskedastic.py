...
from bcp.data_set import load_heteroskedastic
from bcp.losses import miscoverage_loss
...
def run(
    ...
    get_threshold = lambda ds: threshold_fun(
        ds, predict_identity, miscoverage_loss, target_risk, 1.0, MAX_THRESHOLD
    )
    ...
    def run_trial(subkey):
        ...
        val_risk = miscoverage_loss(predictions, val_set.labels).mean(axis=-1)
