#!/usr/bin/env python3
"""
Hardware Safety Monitor for ACC Research Campaign
...
def display_live(gpu, cpu, alerts, tick, start_time):
    ...
    lines.append("=" * 72)
    lines.append("  HARDWARE MONITOR  |  ACC Research Campaign  |  HP Z4 G5 Workstation")
...
def main():
    parser = argparse.ArgumentParser(description="Hardware Safety Monitor for ACC Research Campaign")
