#!/usr/bin/env python3
"""
UAI 2026: Architecture-aware Manifold Sweep (N=512)
...
# Set HF_TOKEN in your environment before running: export HF_TOKEN=your_token_here
# os.environ["HF_TOKEN"] = "<your_hf_token>"  # DO NOT hardcode tokens in source files
...
def main():
    ...
    for m in models:
        try:
            ...
            # Latency Delta for UAI 2026 Strong Accept
